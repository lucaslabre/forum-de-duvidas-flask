...
from forumdeduvidas import app, database, bcrypt
from forumdeduvidas.forms import FormLogin, FormCriarConta, FormEditarPerfil, FormCriarPost
from forumdeduvidas.models import Usuario, Post
...
def sair():
    logout_user()
    flash(f'Loggout realizado com sucesso', 'alert-success')
    return redirect(url_for('home'))
